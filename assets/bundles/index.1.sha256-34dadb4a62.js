try {
    let e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
        t = new e.Error().stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "00f80121-7668-40bb-ab6e-9aa947edfa99", e._sentryDebugIdIdentifier = "sentry-dbid-00f80121-7668-40bb-ab6e-9aa947edfa99")
} catch {}
...
const dt = (e, t, n, {
    ...
    gt = C("HTMLFormElement"),
    St = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function(n, r, s) {
...
const Pt = e => {
    ...
    _t = C("AsyncFunction"),
    Ft = e => e && (X(e) || x(e)) && x(e.then) && x(e.catch),
    Fe = ((e, t) => e ? setImmediate : t ? ((n, r) => (U.addEventListener("message", ({
        source: s,
        data: o
    }) => {
    ...
    Ut = typeof queueMicrotask < "u" ? queueMicrotask.bind(U) : typeof process < "u" && process.nextTick || Fe,
    a = {
        isArray: B,
        isArrayBuffer: xe,
        isBuffer: Ge,
...
function G(e, t, n) {
    ...
    function u(p, y, h) {
        ...
        if (p && !h && typeof p == "object") {
            ...
            else if (a.isArray(p) && Dt(p) || (a.isFileList(p) || a.endsWith(y, "[]")) && (w = a.toArray(p))) return y = De(y), w.forEach(function(S, P) {
                !(a.isUndefined(S) || S === null) && t.append(i === !0 ? pe([y], P, o) : i === null ? y : y + "[]", l(S))
            }), !1
        }
    ...
    function R(p, y) {
        if (!a.isUndefined(p)) {
            ...
            d.push(p), a.forEach(p, function(w, g) {
                (!(a.isUndefined(w) || w === null) && s.call(t, w, a.isString(g) ? g.trim() : g, y, b)) === !0 && R(w, y ? y.concat(g) : [g])
            }), d.pop()
        }
    }
...
const ze = e => {
    ...
    un = ln && function(e) {
        return new Promise(function(n, r) {
            ...
            }), a.isUndefined(s.withCredentials) || (h.withCredentials = !!s.withCredentials), c && c !== "json" && (h.responseType = s.responseType), l && ([b, p] = V(l, !0), h.addEventListener("progress", b)), f && h.upload && ([d, R] = V(f), h.upload.addEventListener("progress", d), h.upload.addEventListener("loadend", R)), (s.cancelToken || s.signal) && (u = S => {
...
const bn = async e => {
    ...
    En = Q && (async e => {
        ...
        try {
            ...
            let g = await fetch(p);
            const S = oe && (l === "stream" || l === "response");
            if (oe && (c || S && y)) {
                const T = {};
...
function Oe(e) {
    return te(e), e.headers = A.from(e.headers), e.data = ee.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), Ve.getAdapter(e.adapter || H.adapter)(e).then(function(r) {
        return te(e), r.data = ee.call(e, e.transformResponse, r), r.headers = A.from(r.headers), r
    }, function(r) {
        return Ie(r) || (te(e), r && r.response && (r.response.data = ee.call(e, e.transformResponse, r.response), r.response.headers = A.from(r.response.headers))), Promise.reject(r)
    })
}
const We = "1.8.4",
    Z = {};
...
//# sourceMappingURL=index.1.sha256-34dadb4a62.js.map