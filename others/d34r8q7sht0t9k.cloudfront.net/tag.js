                ...
                const f = e => {
                    ...
                    i = (e, c, d) => {
                        ...
                        if ("shopify-custom" === d) {
                            ...
                            b.id = "podscribe-request", b.style.display = "none", b.alt = "", b.ariaHidden = !0, b.src = a, document.getElementsByTagName("img"), document.body.appendChild(b)
                        }
                    },
                    n = e => Object.entries(e).reduce(((e, [c, d]) => {
                        if (Array.isArray(d)) {
                    ...
                    o = async (e, f) => {
                        const i = f && f.source ? f.source : "js-tag v1.0.8",
                            n = window.podscribe_advertiser,
                            o = window.podscribe_user_id,
                            s = window.with_stid;
                        let _ = !0;
                        try {
                            new URL(document.URL).origin === new URL(document.referrer).origin && (_ = !1)
                        } catch (e) {}
                        let u = t("__ps_r", `__podscribe_${n}_referrer`);
                        u || (u = document.referrer && _ ? document.referrer : "_", b("__ps_r", u));
                        let l = t("__ps_sr", `__pscrb_s_${n}_referrer`);
                        l || (l = document.referrer && _ ? document.referrer : "_"), b("__ps_sr", l, c);
                        let p = t("__ps_lu", `__podscribe_${n}_landing_url`);
                        p || "view" !== e || (p = _ ? document.URL || "_" : document.referrer || "_", b("__ps_lu", p));
                        let w = t("__ps_slu", `__pscrb_s_${n}_landing_url`);
                        w || "view" !== e || (w = _ ? document.URL || "_" : document.referrer || "_"), w && b("__ps_slu", w, c);
                        let m = f && f.device_id ? f.device_id : t("__ps_did", "__podscribe_did");
                        m && "YOUR_DEVICE_ID_MACRO" !== m && "undefined" !== m && "null" !== m && "_" !== m || (m = "pscrb_" + r(), b("__ps_did", m));
                        let h = t("__ps_fva", `__pscrb_${n}_first_visited_at`);
                        h || (h = (new Date).getTime(), b("__ps_fva", h));
                        let x = "";
                        try {
                            if (!["nakedwines", "wise", "stan", "nutrafol"].includes(n)) {
                    ...
                    _ = async (e, c) => {
                        try {
                            ...
                            if ("view" === e) {
                                ...
                                return void i(a, d.advertiser, d.source)
                            }
                            if (e) {
                                const d = await o(e, c),
                                    a = n({ ...c,
