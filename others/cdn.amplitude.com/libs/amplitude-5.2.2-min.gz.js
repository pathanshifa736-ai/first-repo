! function(e, t) {
    ...
    var f = "$default_instance",
        ...
        R = function(e) {
            for (var t = "", n = 0, i = 0, r = 0, o = 0; n < e.length;)(i = e.charCodeAt(n)) < 128 ? (t += String.fromCharCode(i), n++) : 191 < i && i < 224 ? (r = e.charCodeAt(n + 1), t += String.fromCharCode((31 & i) << 6 | 63 & r), n += 2) : (r = e.charCodeAt(n + 1), o = e.charCodeAt(n + 2), t += String.fromCharCode((15 & i) << 12 | (63 & r) << 6 | 63 & o), n += 3);
            return t
        },
        q = {
            ...
            _encode: function(e) {
                var t, n, i, r, o, s, a, u = "",
                    p = 0;
                for (e = A(e); p < e.length;) r = (t = e.charCodeAt(p++)) >> 2, o = (3 & t) << 4 | (n = e.charCodeAt(p++)) >> 4, s = (15 & n) << 2 | (i = e.charCodeAt(p++)) >> 6, a = 63 & i, isNaN(n) ? s = a = 64 : isNaN(i) && (a = 64), u = u + q._keyStr.charAt(r) + q._keyStr.charAt(o) + q._keyStr.charAt(s) + q._keyStr.charAt(a);
                return u
            },
            decode: function(e) {
                try {
            ...
            _decode: function(e) {
                var t, n, i, r, o, s, a = "",
                    u = 0;
                for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); u < e.length;) t = q._keyStr.indexOf(e.charAt(u++)) << 2 | (r = q._keyStr.indexOf(e.charAt(u++))) >> 4, n = (15 & r) << 4 | (o = q._keyStr.indexOf(e.charAt(u++))) >> 2, i = (3 & o) << 6 | (s = q._keyStr.indexOf(e.charAt(u++))), a += String.fromCharCode(t), 64 !== o && (a += String.fromCharCode(n)), 64 !== s && (a += String.fromCharCode(i));
                return a = R(a)
            }
        },
    ...
    var e, U = {
        ...
        G = function(e) {
            var t = C(e);
            if ("object" !== t) return M.error("Error: invalid properties format. Expecting Javascript object, received " + t + ", ignoring"), {};
            if (Object.keys(e).length > a) return M.error("Error: too many properties (more than 1000), ignoring"), {};
            var n = {};
            for (var i in e)
                if (e.hasOwnProperty(i)) {
                    var r = i,
                        o = C(r);
                    "string" !== o && (r = String(r), M.warn("WARNING: Non-string property key, received type " + o + ', coercing to string "' + r + '"'));
                    var s = F(r, e[i]);
                    null !== s && (n[r] = s)
                }
            return n
        ...
        F = function e(t, n) {
            var i = C(n);
            if (-1 !== L.indexOf(i)) M.warn('WARNING: Property key "' + t + '" with invalid value type ' + i + ", ignoring"), n = null;
            else if ("undefined" === i) n = null;
            else if ("error" === i) n = String(n), M.warn('WARNING: Property key "' + t + '" with value type error, coercing to ' + n);
            else if ("array" === i) {
        ...
        K = function(e, t) {
            ...
            if ("date" === n || "number" === n || "boolean" === n) return t = String(t), M.warn("WARNING: Non-string groupName, received type " + n + ', coercing to string "' + t + '"'), t;
            if ("array" === n) {
                for (var i = [], r = 0; r < t.length; r++) {
                    var o = t[r],
                        s = C(o);
                    "array" !== s && "object" !== s ? "string" === s ? i.push(o) : "date" !== s && "number" !== s && "boolean" !== s || (o = String(o), M.warn("WARNING: Non-string groupName, received type " + s + ', coercing to string "' + o + '"'), i.push(o)) : M.warn("WARNING: Skipping nested " + s + " in array groupName")
                }
                return i
            }
        ...
        X = function(e) {
            var t = C(e);
            if ("object" !== t) return M.error("Error: invalid groups format. Expecting Javascript object, received " + t + ", ignoring"), {};
            var n = {};
            for (var i in e)
                if (e.hasOwnProperty(i)) {
                    var r = i,
                        o = C(r);
                    "string" !== o && (r = String(r), M.warn("WARNING: Non-string groupType, received type " + o + ', coercing to string "' + r + '"'));
                    var s = K(r, e[i]);
                    null !== s && (n[r] = s)
                }
            return n
        ...
        H = function(e, t, n) {
            return C(e) === n || (M.error("Invalid " + t + " input type. Expected " + n + " but received " + C(e)), !1)
        },
        Z = G,
        Y = function(e, t, n) {
            ...
            var o = e + "=" + t;
            i && (o += "; expires=" + i.toUTCString()), o += "; path=/", n.domain && (o += "; domain=" + n.domain), n.secure && (o += "; Secure"), document.cookie = o
        },
        ee = function(e) {
            try {
        ...
        ne = function(e) {
            var t, n, i = (t = e, (n = document.createElement("a")).href = t, n.hostname || location.hostname).split("."),
                r = i[i.length - 1],
                o = [];
            if (4 === i.length && r === parseInt(r, 10)) return o;
            if (i.length <= 1) return o;
            for (var s = i.length - 2; 0 <= s; --s) o.push(i.slice(s).join("."));
            for (var a = 0; a < o.length; ++a) {
                ...
                if (Y(u, 1, c), ee(u)) return Y(u, null, c), p
            }
            return ""
        },
        ie = function(e) {
        ...
        re = function(e) {
            var t = ie(e) + "=",
                n = ee(t);
            try {
                if (n) return JSON.parse(q.decode(n))
            } catch (e) {
                return null
            }
            return null
        ...
        oe = function(e, t) {
            try {
                return Y(ie(e), q.encode(JSON.stringify(t)), te), !0
            } catch (e) {
                return !1
            }
        },
        ...
        ae = {
            ...
            options: function(e) {
                ...
                e = e || {}, te.expirationDays = e.expirationDays, te.secure = e.secure;
                var t = $(e.domain) ? "." + ne(window.location.href) : e.domain,
                    n = Math.random();
                te.domain = t, oe("amplitude_test", n);
                var i = re("amplitude_test");
                return i && i === n || (t = null), se("amplitude_test"), te.domain = t, te
            },
            get: re,
            set: oe,
            remove: se
    ...
    if (function() {
        ...
        var ue = document.createElement("div"),
            pe = "localStorage";
        ue.style.display = "none", document.getElementsByTagName("head")[0].appendChild(ue), ue.addBehavior && (ue.addBehavior("#default#userdata"), e = {
            length: 0,
            setItem: function(e, t) {
                ue.load(pe), ue.getAttribute(e) || this.length++, ue.setAttribute(e, t), ue.save(pe)
            },
            getItem: function(e) {
                return ue.load(pe), ue.getAttribute(e)
            },
            removeItem: function(e) {
                ue.load(pe), ue.getAttribute(e) && this.length--, ue.removeAttribute(e), ue.save(pe)
            },
            clear: function() {
                ue.load(pe);
                for (var e, t = 0; e = ue.XMLDocument.documentElement.attributes[t++];) ue.removeAttribute(e.name);
                ue.save(pe), this.length = 0
            },
            key: function(e) {
                return ue.load(pe), ue.XMLDocument.documentElement.attributes[e]
            }
        }, ue.load(pe), e.length = ue.XMLDocument.documentElement.attributes.length)
    }
    e || (e = {
        length: 0,
        setItem: function(e, t) {},
    ...
    de.prototype._cookiesEnabled = function() {
        ...
        try {
            return ae.set(i, t), e = ae.get(i) === t, ae.remove(i), e
        } catch (e) {}
        return !1
        ...
        if (this._cookiesEnabled()) this.storage = ae;
            ...
            this.storage = {
                ...
                options: function(e) {
                    return 0 === arguments.length ? this._options : (e = e || {}, this._options.expirationDays = e.expirationDays || this._options.expirationDays, this._options.domain = e.domain || this._options.domain || window.location.hostname, this._options.secure = e.secure || !1)
                },
                get: function(e) {
                    try {
    ...
    fe.prototype.add = function(e, t) {
        return "number" === C(t) || "string" === C(t) ? this._addOperation("$add", e, t) : W.error("Unsupported type for value: " + C(t) + ", expecting number or string"), this
    }, fe.prototype.append = function(e, t) {
        return this._addOperation("$append", e, t), this
    }, fe.prototype.clearAll = function() {
        return 0 < Object.keys(this.userPropertiesOperations).length ? this.userPropertiesOperations.hasOwnProperty(le) || W.error("Need to send $clearAll on its own Identify object without any other operations, skipping $clearAll") : this.userPropertiesOperations[le] = "-", this
                ...
                function o(e, t) {
                    return function(e, t) {
                        var n, i, r = c(e),
                            o = [],
                            s = [];
                        for (o[15] = s[15] = void 0, 16 < r.length && (r = u(r, 8 * e.length)), n = 0; n < 16; n += 1) o[n] = 909522486 ^ r[n], s[n] = 1549556828 ^ r[n];
                        return i = u(o.concat(c(t)), 512 + 8 * t.length), p(u(s.concat(i), 640))
                    }(n(e), n(t))
                }
    ...
    xe.prototype.setProductId = function(e) {
        return "string" !== C(e) ? W.error("Unsupported type for productId: " + C(e) + ", expecting string") : $(e) ? W.error("Invalid empty productId") : this._productId = e, this
    }, xe.prototype.setQuantity = function(e) {
        return "number" !== C(e) ? W.error("Unsupported type for quantity: " + C(e) + ", expecting number") : this._quantity = parseInt(e), this
    }, xe.prototype.setPrice = function(e) {
        return "number" !== C(e) ? W.error("Unsupported type for price: " + C(e) + ", expecting number") : this._price = e, this
    }, xe.prototype.setRevenueType = function(e) {
        return "string" !== C(e) ? W.error("Unsupported type for revenueType: " + C(e) + ", expecting string") : this._revenueType = e, this
    }, xe.prototype.setEventProperties = function(e) {
        return "object" !== C(e) ? W.error("Unsupported type for eventProperties: " + C(e) + ", expecting object") : this._properties = Z(e), this
    }, xe.prototype._isValidRevenue = function() {
        return "number" === C(this._price) || (W.error("Invalid revenue, need to set price field"), !1)
    }, xe.prototype._toJSONObject = function() {
        var e = "object" === C(this._properties) ? this._properties : {};
        return null !== this._productId && (e[s] = this._productId), null !== this._quantity && (e[u] = this._quantity), null !== this._price && (e[p] = this._price), null !== this._revenueType && (e[d] = this._revenueType), e
    };
    var Ne = ge(function(b, I) {
            ! function(r, d) {
                var l = "function",
                        ...
                        rgx: function(e, t) {
                            for (var n, i, r, o, s, a, u = 0; u < t.length && !s;) {
                                ...
                                for (n = i = 0; n < p.length && !s;)
                                    if (s = p[n++].exec(e))
                                        for (r = 0; r < c.length; r++) a = s[++i], "object" == typeof(o = c[r]) && 0 < o.length ? 2 == o.length ? typeof o[1] == l ? this[o[0]] = o[1].call(this, a) : this[o[0]] = o[1] : 3 == o.length ? typeof o[1] !== l || o[1].exec && o[1].test ? this[o[0]] = a ? a.replace(o[1], o[2]) : d : this[o[0]] = a ? o[1].call(this, a, o[2]) : d : 4 == o.length && (this[o[0]] = a ? o[3].call(this, a.replace(o[1], o[2])) : d) : this[o] = a || d;
                                u += 2
                            }
                        },
                        str: function(e, t) {
                    ...
                    m = {
                        browser: [
                            ...
                            [t, [o, g.str, v.browser.oldsafari.version]],
                            [/(webkit|khtml)\/([\w\.]+)/i],
                            [t, o],
                        ...
                        device: [
                            ...
                            [/(sprint\s(\w+))/i],
                            [
                                [i, g.str, v.device.sprint.vendor],
                                [e, g.str, v.device.sprint.model],
                                [n, u]
                            ],
                        ...
                        os: [
                            ...
                            [
                                [t, g.str, v.os.windows.name],
                                [o, g.str, v.os.windows.version]
                            ],
                ...
                y.VERSION = "0.7.19", y.BROWSER = {
                    ...
                    NAME: t,
                    VERSION: o
                }, b.exports && (I = b.exports = y), I.UAParser = y;
        ...
        Ae = function(e) {
            this._instanceName = $(e) ? f : e.toLowerCase(), this._legacyStorageSuffix = this._instanceName === f ? "" : "_" + this._instanceName, this._unsentEvents = [], this._unsentIdentifys = [], this._ua = new Ne(navigator.userAgent).getResult(), this.options = l({}, Pe, {
    ...
    Ae.prototype.Identify = fe, Ae.prototype.Revenue = xe, Ae.prototype.init = function(e, t, n, i) {
        if ("string" !== C(e) || $(e)) W.error("Invalid apiKey. Please re-initialize with a valid apiKey");
        else {
            try {
                this.options.apiKey = e, this._storageSuffix = "_" + e + this._legacyStorageSuffix, Re(this.options, n), "string" === C(this.options.logLevel) && V(this.options.logLevel);
                var r = Be(this);
                if (this._apiPropertiesTrackingOptions = 0 < Object.keys(r).length ? {
                    ...
                    for (var o = 0; o < this._unsentEvents.length; o++) {
                        ...
                        this._unsentEvents[o].event_properties = Z(s), this._unsentEvents[o].groups = X(a)
                    }
                    for (var u = 0; u < this._unsentIdentifys.length; u++) {
                        ...
                        this._unsentIdentifys[u].user_properties = Z(p), this._unsentIdentifys[u].groups = X(c)
                    }
                }
            ...
            for (var l = 0; l < this._onInit.length; l++) this._onInit[l]();
            this._onInit = [], this._isInitialized = !0
        }
    ...
    var Re = function i(r, o) {
        if ("object" === C(o)) {
            ...
            for (var t in o) o.hasOwnProperty(t) && e(t)
        }
    };
    Ae.prototype.runQueuedFunctions = function() {
        ...
        return !$(this.options.apiKey) || (W.error("Invalid apiKey. Please set a valid apiKey with init() before calling " + e), !1)
        ...
        return this._removeFromLegacyStorage(ce, e), this._setInStorage(ce, e, JSON.stringify(r)), r
    ...
    Ae.prototype._initUtmData = function(e, t) {
        ...
        var n, i, r, o, s, a, u, p, c, d, l, f = (i = e, r = (n = t) ? "?" + n.split(".").slice(-1)[0].replace(/\|/g, "&") : "", s = (o = function(e, t, n, i) {
            return J(e, t) || J(n, i)
        })(x, i, "utmcsr", r), a = o(N, i, "utmcmd", r), u = o(k, i, "utmccn", r), p = o(T, i, "utmctr", r), c = o(P, i, "utmcct", r), d = {}, (l = function(e, t) {
            $(t) || (d[e] = t)
        })(x, s), l(N, a), l(k, u), l(T, p), l(P, c), d);
        De(this, f)
    }, Ae.prototype._unsetUTMParams = function() {
        var e = new fe;
        e.unset(O), e.unset(x), e.unset(N), e.unset(k), e.unset(T), e.unset(P), this.identify(e)
    };
    var De = function(e, t) {
    ...
    Ae.prototype._getReferrer = function() {
        ...
        if (H(e, "domain", "string")) try {
            this.cookieStorage.options({
                domain: e
            }), this.options.domain = this.cookieStorage.options().domain, je(this), Ue(this)
        } catch (e) {
            W.error(e)
        }
    }, Ae.prototype.setUserId = function(e) {
        try {
            this.options.userId = null != e && "" + e || null, Ue(this)
        } catch (e) {
            W.error(e)
        }
        ...
        if (H(e, "deviceId", "string")) try {
            $(e) || (this.options.deviceId = "" + e, Ue(this))
        } catch (e) {
            W.error(e)
        }
    ...
    Ae.prototype.identify = function(e, t) {
        if (this._apiKeySet("identify()"))
            if ("object" === C(e) && e.hasOwnProperty("_q") && (e = Me(new fe, e)), e instanceof fe) {
                if (0 < Object.keys(e.userPropertiesOperations).length) return this._logEvent(h, null, null, e.userPropertiesOperations, null, null, null, t);
                "function" === C(t) && t(0, "No request sent", {
                    reason: "No user property operations"
                })
            } else W.error("Invalid identify input type. Expected Identify object but saw " + C(e)), "function" === C(t) && t(0, "No request sent", {
        ...
        if (this._apiKeySet("groupIdentify()"))
            if (H(e, "group_type", "string") && !$(e))
                if (null != t)
                    if ("object" === C(n) && n.hasOwnProperty("_q") && (n = Me(new fe, n)), n instanceof fe) {
                        if (0 < Object.keys(n.userPropertiesOperations).length) return this._logEvent(g, null, null, null, r({}, e, t), n.userPropertiesOperations, null, i);
                        "function" === C(i) && i(0, "No request sent", {
                            reason: "No group property operations"
                        })
                    } else W.error("Invalid identify input type. Expected Identify object but saw " + C(n)), "function" === C(i) && i(0, "No request sent", {
                        reason: "Invalid identify input type"
                    });
        ...
        if (je(this), e)
            if (this.options.optOut) "function" === C(a) && a(0, "No request sent", {
                ...
                (!this._sessionId || !this._lastEventTime || c - this._lastEventTime > this.options.sessionTimeout) && (this._sessionId = c), this._lastEventTime = c, Ue(this), i = i || {}, n = l({}, n || {}, l({}, this._apiPropertiesTrackingOptions)), t = t || {}, r = r || {}, o = o || {};
                var d = {
                ...
                return e === h || e === g ? (this._unsentIdentifys.push(d), this._limitEventsQueued(this._unsentIdentifys)) : (this._unsentEvents.push(d), this._limitEventsQueued(this._unsentEvents)), this.options.saveEvents && this.saveEvents(), this._sendEventsIfReady(a) || "function" !== C(a) || a(0, "No request sent", {
                    reason: "No events to send or upload queued"
                }), u
            } catch (e) {
                W.error(e)
            } else "function" === C(a) && a(0, "No request sent", {
    ...
    Ae.prototype.logRevenueV2 = function(e) {
        if (this._apiKeySet("logRevenueV2()"))
            if ("object" === C(e) && e.hasOwnProperty("_q") && (e = Me(new xe, e)), e instanceof xe) {
                if (e && e._isValidRevenue()) return this.logEvent(o, e._toJSONObject())
            } else W.error("Invalid revenue input type. Expected Revenue object but saw " + C(e))
        ...
        Le(this, "_unsentEvents", e), Le(this, "_unsentIdentifys", t)
    };
    var Le = function(e, t, n) {
        if (!(n < 0)) {
            for (var i = [], r = 0; r < e[t].length; r++) e[t][r].event_id > n && i.push(e[t][r]);
            e[t] = i
        }
    };
    Ae.prototype.sendEvents = function(n) {
        if (this._apiKeySet("sendEvents()"))
            if (this.options.optOut) "function" === C(n) && n(0, "No request sent", {
                reason: "optOut is set to true"
            });
            else if (0 !== this._unsentCount())
            if (this._sending) "function" === C(n) && n(0, "No request sent", {
                ...
                new Oe(e, u).send(function(e, t) {
                    p._sending = !1;
                    try {
                        200 === e && "success" === t ? (p.removeEvents(r, o), p.options.saveEvents && p.saveEvents(), p._sendEventsIfReady(n) || "function" !== C(n) || n(e, t)) : 413 === e ? (1 === p.options.uploadBatchSize && p.removeEvents(r, o), p.options.uploadBatchSize = Math.ceil(i / 2), p.sendEvents(n)) : "function" === C(n) && n(e, t)
                    } catch (e) {}
                })
            }
        else "function" === C(n) && n(0, "No request sent", {
        ...
        for (var t = [], n = 0, i = -1, r = 0, o = -1; t.length < e;) {
            var s, a = r >= this._unsentIdentifys.length,
                u = n >= this._unsentEvents.length;
            if (u && a) {
                W.error("Merging Events and Identifys, less events and identifys than expected");
                break
            }
            a ? i = (s = this._unsentEvents[n++]).event_id : u ? o = (s = this._unsentIdentifys[r++]).event_id : !("sequence_number" in this._unsentEvents[n]) || this._unsentEvents[n].sequence_number < this._unsentIdentifys[r].sequence_number ? i = (s = this._unsentEvents[n++]).event_id : o = (s = this._unsentIdentifys[r++]).event_id, t.push(s)
        }
        return {
            eventsToSend: t,
            maxEventId: i,
    ...
    var Fe = function() {
        this.options = l({}, Pe), this._q = [], this._instances = {}
    };
    Fe.prototype.Identify = fe, Fe.prototype.Revenue = xe, Fe.prototype.getInstance = function(e) {
        e = $(e) ? f : e.toLowerCase();
    ...
    var Ke = window.amplitude || {},
        Ve = new Fe;
    for (var We in Ve._q = Ke._q || [], Ke._iq) Ke._iq.hasOwnProperty(We) && (Ve.getInstance(We)._q = Ke._iq[We]._q || []);
    return Ve.runQueuedFunctions(), Ve
});