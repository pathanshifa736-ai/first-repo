  ...
  <a id="nav__a--home" class="nav__link" href="/" aria-label="Home">
    <img src="../assets/sparqulen.png" alt="Logo" style="height:50px;width:auto;object-fit:contain;">
        ...
        <li class="nav-item nav-item--services-pricing">
          <a id="nav__a--services-pricing" class="nav__link " href="/services-pricing/">Services </a>
        </li>
