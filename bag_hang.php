...
<!-- End StackAdapt Pixel Code -->
  ...
  if ('San Francisco' && 'San Francisco' === 'Washington DC') {
    ...
    <title>Rinse - Wash &amp; Fold, Dry Cleaning, and Hang Dry service, delivered right to your door</title>
  ...
  <div class="dynamic-schedule-cta__icon-circle rinse-button--primary-new no-transform" aria-hidden="true" data-dynamic-schedule-cta-area="arrow">
    <span class="dynamic-schedule-cta__icon rinse-icon rinse-icon--arrow-right-long"></span>
      ...
      <div data-discount-container=""><div class="_boxWrapper_4d1yf_6" role="button" tabindex="0" aria-label="View your discount details"><div class="_box_ub4zd_6 _boxPositive_ub4zd_18 _box_4d1yf_6 _box_1ume7_6"><div class="_main_ub4zd_41"><p class="_text_ub4zd_52 _text_1ume7_24" role="alert">Your $20 off in credits will be automatically applied</p></div></div></div></div>
            ...
            <li data-service-type="os" class="switcher-active">
  ...
  <section class="section section--full-width section--other-services sticky-media__content-item sticky-media__content-item--other-services" data-associated-media-id="image--hang-dry" data-scrollspy-content="">
    ...
    <div class="clamp-width" role="group" aria-label="Hang Dry details">
      <div class="other-service-subsection services-pricing-section-grid">
        ...
        <figure class="show@m services-pricing__sticky-media sticky-media__media shadow--media media--active scrollspy-media--active is_absolute--top" data-scrollspy-media="" data-sticky-media="" data-sticky-media--center="" id="image--hang-dry" aria-hidden="true" style="">
  ...
  <section class="section section--full-width section--other-services sticky-media__content-item sticky-media__content-item--other-services" data-associated-media-id="image--donations" data-scrollspy-content="">
    ...
    <div class="clamp-width" role="group" aria-label="Clothing Donation details">
      <div class="other-service-subsection services-pricing-section-grid">
        ...
        <figure class="show@m services-pricing__sticky-media sticky-media__media shadow--media media--active" data-scrollspy-media="" data-sticky-media="" data-sticky-media--center="" id="image--donations" aria-hidden="true" style="">
...
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "Service", "serviceType": "Hang Dry service", "provider": {"@type": "Organization", "name": "Rinse", "url": "https://www.rinse.com/#organization"}, "hasOfferCatalog": {"@type": "OfferCatalog", "name": "Hang Dry Price List", "itemListElement": [{"@type": "Offer", "name": "Undergarments", "businessFunction": "http://purl.org/goodrelations/v1#ProvideService", "priceCurrency": "USD", "price": {"amount": "1.50", "currency": "USD", "type": "Money"}}, {"@type": "Offer", "name": "Shirt", "businessFunction": "http://purl.org/goodrelations/v1#ProvideService", "priceCurrency": "USD", "price": {"amount": "4.95", "currency": "USD", "type": "Money"}}, {"@type": "Offer", "name": "Synthetics / Activewear", "businessFunction": "http://purl.org/goodrelations/v1#ProvideService", "priceCurrency": "USD", "price": {"amount": "4.95", "currency": "USD", "type": "Money"}}, {"@type": "Offer", "name": "All Other Items", "businessFunction": "http://purl.org/goodrelations/v1#ProvideService", "priceCurrency": "USD", "price": {"amount": "6.95", "currency": "USD", "type": "Money"}}]}}</script>
    ...
    <section id="services-pricing__service-details" class="section" style="order: 2; display: none;" data-collapse-if-empty="">
...
<div class="icon-step-container icon-step-container--services-pricing" itemscope="" itemtype="https://schema.org/HowTo">
  ...
  <div class="icon-step" itemprop="step" itemscope="" itemtype="https://schema.org/HowToStep">
    ...
    <section id="services-pricing__section--pricing" class="section" style="order: 3; display: none;" data-collapse-if-empty="">
        <ul class="services-pricing-service-switcher" data-service-switcher="" role="presentation">
            <li data-service-type="wf" class="">
